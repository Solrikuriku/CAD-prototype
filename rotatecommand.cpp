...
void RotateCommand::OnMouseMove(QMouseEvent *e)
{
    ...
    if (m_axes == TransformAxes::X) rotatePlane = objectRotate * QVector3D(1, 0, 0);
    else if (m_axes == TransformAxes::Y) rotatePlane = objectRotate * QVector3D(0, 1, 0);
    else if (m_axes == TransformAxes::Z) rotatePlane = objectRotate * QVector3D(0, 0, 1);
    ...
    objectRotate = objectRotate * deltaRotation;
